...
import com.example.demo.src.member.UserProvider;
import com.example.demo.src.member.UserService;
...
public class AccomDetailController {
    ...
    public AccomDetailController(UserProvider userProvider, UserService userService, JwtService jwtService){
